...
Field Agents: HQ issues a 10-character code under **Polling units → PU Agents**. Agents sign in at **http://localhost:3000/agent/login** (or the CCC Agent app). GPS must match the assigned unit (5 km). Older 8-character codes still work until they expire.
