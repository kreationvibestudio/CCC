...
export const NAV_ITEMS: NavItem[] = [
  ...
  { title: "Training Management", href: "/training", icon: GraduationCap, permission: "volunteers.view" },
...
export const QUICK_ACTIONS = [
  ...
  { title: "Training Management", href: "/training", permission: "volunteers.view" as Permission, creates: false },
